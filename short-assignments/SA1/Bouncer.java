...
public class Bouncer extends Blob {
	...
	/**
	 * Initializes with the given coordinates, bouncing area size, radius, and color - assigns random step sizes
	 * 
	 * @param x		initial x location
	 * @param y		initial y location
	 * @param xmax	bouncing area size x
	 * @param ymax	bouncing area size y
	 * @param r		initial radius
	 * @param c		color
	 */
	public Bouncer(double x, double y, int xmax, int ymax, double r, Color c) {
		super(x, y);
		this.xmax = xmax; this.ymax = ymax;
		this.r = r;
